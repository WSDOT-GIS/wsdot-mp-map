...
return transformWorldFromViewTL + vPositionWorldCameraRelative;
}`)}class ds extends vr{constructor(){super(...arguments),this.transformWorldFromViewTH=$(),this.transformWorldFromViewTL=$(),this.transformViewFromCameraRelativeRS=xt(),this.transformProjFromView=Vt()}}function Qo(t,e){switch(e.normalType){case B.Attribute:case B.Compressed:t.include(Ht,e),t.varyings.add("vNormalWorld","vec3"),t.varyings.add("vNormalView","vec3"),t.vertex.uniforms.add(new Xo("transformNormalGlobalFromModel",r=>r.transformNormalGlobalFromModel),new pe("transformNormalViewFromGlobal",r=>r.transformNormalViewFromGlobal)),t.vertex.code.add(s`void forwardNormal() {
...
color.a = 1.0;
}`);break;case X.Mask:o.code.add(s`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } else { color.a = 1.0; } }`);break;case X.MaskBlend:t.fragment.code.add(s`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } }`)}}function hi(t,e){const{vertex:r,fragment:o}=t,i=e.hasModelTransformation;if(i){const n=xt();r.uniforms.add(new ze("model",l=>l.modelTransformation??Xe)),r.uniforms.add(new pe("normalTransform",l=>(Rt(n,l.modelTransformation??Xe),n)))}const a=e.hasColorTexture&&e.alphaDiscardMode!==X.Opaque;switch(e.output){case y.Depth:case y.Shadow:case y.ShadowHighlight:case y.ShadowExcludeHighlight:case y.ObjectAndLayerIdColor:pt(r,e),t.include(ft,e),t.include(qe,e),t.include(vt,e),t.include(Is,e),t.include(Be,e),t.include($s,e),Jo(t),t.varyings.add("depth","float"),a&&o.uniforms.add(new Z("tex",n=>n.texture)),r.code.add(s`
          void main(void) {
            vpos = calculateVPos();
...
precision highp sampler2D;`,Yt=4;function Qs(){const t=new kt,e=t.fragment;t.include(mi);const r=(Yt+1)/2,o=1/(2*r*r);return e.include(Or),e.uniforms.add(new Z("depthMap",i=>i.depthTexture),new mt("tex",i=>i.colorTexture),new Gs("blurSize",i=>i.blurSize),new ee("projScale",(i,a)=>{const n=Vi(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,i.projScale-(n-5e4)):i.projScale}),new Ce("nearFar",(i,a)=>a.camera.nearFar)),e.code.add(s`
  ...
  `),t}const Zs=Object.freeze(Object.defineProperty({__proto__:null,build:Qs},Symbol.toStringTag,{value:"Module"}));let Js=class gi extends yr{initializeProgram(e){return new Cr(e.rctx,gi.shader.get().build(),Gt)}initializePipeline(){return gr({colorWrite:xr})}};Js.shader=new Wt(Zs,()=>_t(()=>import("./SSAOBlur.glsl-c2337e30.js"),["assets/SSAOBlur.glsl-c2337e30.js","assets/mathUtils-bda3ea21.js","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3-0b5b6163.js","assets/mat3f64-221ce671.js","assets/mat4-4008362f.js","assets/mat4f64-1413b4a7.js","assets/aaBoundingBox-ae1fcc82.js","assets/Extent-4cd130bc.js","assets/Point-04dbd693.js","assets/config-94cb5807.js","assets/BufferView-607fe046.js","assets/vec2-3974b6aa.js","assets/vec32-7e5dc724.js","assets/DefaultMaterial_COLOR_GAMMA-6f598340.js","assets/geometry-105cdd21.js","assets/index-e6c8bd3f.js","assets/asyncUtils-2aa2cc5c.js","assets/Version-80b94666.js","assets/quat-15bb81e8.js","assets/quatf64-3363c48e.js","assets/compilerUtils-63536163.js","assets/resourceUtils-1d112ccb.js","assets/Indices-2e96ec38.js","assets/mat3f32-6c416b1c.js","assets/vec2f32-eaf29605.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-d5ffd456.js","assets/Util-44dbba6f.js","assets/vec2f64-22afc56f.js","assets/vec4f64-aa64c7e9.js","assets/sphere-32941669.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-5313fdb5.js","assets/assets-c862f459.js","assets/Texture-11bb7e48.js","assets/contextUtils-3f19c605.js","assets/ViewingMode-915d19cb.js","assets/InterleavedLayout-2b0aaac2.js","assets/types-1305598a.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-73fdf1a1.js","assets/lengthUtils-a208fb47.js","assets/VertexElementDescriptor-2925c6af.js","assets/VertexArrayObject-d54bbe8d.js"]));function Ys(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>el(r))),t.fragment.uniforms.add(new Ce("zScale",(e,r)=>xi(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
return vec3((fragCoord * projInfo.xy + projInfo.zw) * (zScale.x * depth + zScale.y), depth);
}`)}function el(t){const e=t.camera.projectionMatrix;return e[11]===0?oe(no,2/(t.camera.fullWidth*e[0]),2/(t.camera.fullHeight*e[5]),(1+e[12])/e[0],(1+e[13])/e[5]):oe(no,-2/(t.camera.fullWidth*e[0]),-2/(t.camera.fullHeight*e[5]),(1-e[8])/e[0],(1-e[9])/e[5])}const no=Ut();function xi(t){return t.camera.projectionMatrix[11]===0?$t(so,0,1):$t(so,1,0)}const so=Oo(),lo=16;function tl(){const t=new kt,e=t.fragment;return t.include(mi),e.include(Or),t.include(Ys),e.uniforms.add(new ee("radius",(r,o)=>Ti(o.camera))),e.code.add(s`vec3 sphere[16];
void fillSphere() {
...
return fallOffFunction(vv, vn, 0.1);
}`),e.uniforms.add(new Ce("nearFar",(r,o)=>o.camera.nearFar),new Z("normalMap",r=>r.normalTexture),new Z("depthMap",r=>r.depthTexture),new Ce("zScale",(r,o)=>xi(o)),new ee("projScale",r=>r.projScale),new Z("rnm",r=>r.noiseTexture),new Ce("rnmScale",(r,o)=>$t(co,o.camera.fullWidth/r.noiseTexture.descriptor.width,o.camera.fullHeight/r.noiseTexture.descriptor.height)),new ee("intensity",r=>r.intensity),new Ce("screenSize",(r,o)=>$t(co,o.camera.fullWidth,o.camera.fullHeight))),e.code.add(s`
    void main(void) {
      fillSphere();
  ...
  `),t}function Ti(t){return Math.max(10,20*t.computeScreenPixelSizeAtDist(Math.abs(4*t.relativeElevation)))}const co=Oo(),rl=Object.freeze(Object.defineProperty({__proto__:null,build:tl,getRadius:Ti},Symbol.toStringTag,{value:"Module"}));let ol=class _i extends yr{initializeProgram(e){return new Cr(e.rctx,_i.shader.get().build(),Gt)}initializePipeline(){return gr({colorWrite:xr})}};ol.shader=new Wt(rl,()=>_t(()=>import("./SSAO.glsl-ce3a4bda.js"),["assets/SSAO.glsl-ce3a4bda.js","assets/vec2-3974b6aa.js","assets/mathUtils-bda3ea21.js","assets/vec2f64-22afc56f.js","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/vec4f64-aa64c7e9.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3-0b5b6163.js","assets/mat3f64-221ce671.js","assets/mat4-4008362f.js","assets/mat4f64-1413b4a7.js","assets/aaBoundingBox-ae1fcc82.js","assets/Extent-4cd130bc.js","assets/Point-04dbd693.js","assets/config-94cb5807.js","assets/BufferView-607fe046.js","assets/vec32-7e5dc724.js","assets/DefaultMaterial_COLOR_GAMMA-6f598340.js","assets/geometry-105cdd21.js","assets/index-e6c8bd3f.js","assets/asyncUtils-2aa2cc5c.js","assets/Version-80b94666.js","assets/quat-15bb81e8.js","assets/quatf64-3363c48e.js","assets/compilerUtils-63536163.js","assets/resourceUtils-1d112ccb.js","assets/Indices-2e96ec38.js","assets/mat3f32-6c416b1c.js","assets/vec2f32-eaf29605.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-d5ffd456.js","assets/Util-44dbba6f.js","assets/sphere-32941669.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-5313fdb5.js","assets/assets-c862f459.js","assets/Texture-11bb7e48.js","assets/contextUtils-3f19c605.js","assets/ViewingMode-915d19cb.js","assets/InterleavedLayout-2b0aaac2.js","assets/types-1305598a.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-73fdf1a1.js","assets/lengthUtils-a208fb47.js","assets/VertexElementDescriptor-2925c6af.js","assets/VertexArrayObject-d54bbe8d.js"]));const il=2;function Er(t,e){const r=t.fragment;e.receiveAmbientOcclusion?(r.uniforms.add(new Z("ssaoTex",(o,i)=>i.ssaoHelper.colorTexture)),r.constants.add("blurSizePixelsInverse","float",1/il),r.code.add(s`float evaluateAmbientOcclusionInverse() {
